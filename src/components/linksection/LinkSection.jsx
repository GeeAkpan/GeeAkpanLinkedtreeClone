  ...
  return (
    <div className='link__section'>
      ...
      <div className='link__section-twitter scale-up-center'>
        <button id='twitter'>
          <a href="https://twitter.com/geeakpan">Twitter Link</a>
        </button>
      </div>
      ...
      <div className='link__section-pythonbooks scale-up-center'>
        <button id='book__python'>
          <a href="https://books.zuri.team/python-for-beginners?ref_id=geeakpan">Python Books</a>
        </button>
      </div>
      ...
      <div className='link__section-designbooks scale-up-center'>
        <button id='book__design'>
          <a href="https://books.zuri.team/python-for-beginners?ref_id=geeakpan">Design Books</a>
        </button>
      </div>
